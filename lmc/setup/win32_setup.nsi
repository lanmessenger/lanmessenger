...
;Constants
  ...
  !define ProductVersion "1.1.52"
  !define InstallerVersion "1.1.5.2"
...
;Interface Settings
  ...
  !define MUI_ICON "win32_package\images\setup.ico"
  !define MUI_UNICON "win32_package\images\setup.ico"
  !define MUI_HEADERIMAGE
  !define MUI_HEADERIMAGE_BITMAP "win32_package\images\header-r.bmp"
  !define MUI_HEADERIMAGE_UNBITMAP "win32_package\images\header-r.bmp"
  !define MUI_HEADERIMAGE_RIGHT
  !define MUI_WELCOMEFINISHPAGE_BITMAP "win32_package\images\banner.bmp"
  !define MUI_UNWELCOMEFINISHPAGE_BITMAP "win32_package\images\banner.bmp"
...
;Pages
  ...
  !insertmacro MUI_PAGE_LICENSE "win32_package\eula\license.txt"
...
Section
  ...
  File "..\release\sounds\filedone.wav"
  File "..\release\sounds\newfile.wav"
  File "..\release\sounds\newmessage.wav"
  File "..\release\sounds\useroffline.wav"
  File "..\release\sounds\useronline.wav"
